...
/** \brief Updater class for online updates of the software
*
...
*       5. close the software and lunch the new installation procedure
*
*/
class BioZone6_updater : public  QMainWindow
{
...
Q_OBJECT
	...
	*/
	signals :
		...
		void exit();   //!< signal generated to close the software for the actual update
		void updateAvailable();

public:

	explicit BioZone6_updater(QWidget *parent = 0); //!< Explicit ctor

	~BioZone6_updater(); //!< dtor
...
private:
	...
	*/
	...
	/** \brief After the download take care of the installation procedure, the software is terminated automatically here
	*
	*/
