...
void BioZone6_GUI::updatePonSetPoint(double _pon_set_point)
{
...
void BioZone6_GUI::updatePoffSetPoint(double _poff_set_point)
{	
	// update the set point
...
void BioZone6_GUI::updateVrecircSetPoint(double _v_recirc_set_point)
{
	// update the set point
...
void BioZone6_GUI::updateVswitchSetPoint(double _v_switch_set_point)
{
	// update the set point
...
void BioZone6_GUI::pressurePonDown() {
...
void BioZone6_GUI::pressurePonUp() {
	std::cout << HERE << std::endl;
...
void BioZone6_GUI::pressurePoffDown() {
	std::cout << HERE << std::endl;
...
void BioZone6_GUI::pressurePoffUp() {
	std::cout << HERE << std::endl;
...
void BioZone6_GUI::pressButtonPressed_switchDown() {
	std::cout << HERE << std::endl;
...
void BioZone6_GUI::pressButtonPressed_switchUp() {
	std::cout << HERE << std::endl;
...
void BioZone6_GUI::recirculationDown() {
	std::cout << HERE << std::endl;
...
void BioZone6_GUI::recirculationUp() {
	std::cout << HERE << std::endl;
...
void BioZone6_GUI::sliderPonChanged(int _value) {
...
void BioZone6_GUI::sliderPoffChanged(int _value) {
...
void BioZone6_GUI::sliderRecircChanged(int _value) {
...
void BioZone6_GUI::sliderSwitchChanged(int _value) {
...
void BioZone6_GUI::resetPreset1() {
...
void BioZone6_GUI::resetPreset2() {
...
void BioZone6_GUI::resetPreset3() {
