...
void BioZone6_GUI::openSettingsFile() {  // open setting file
...
bool BioZone6_GUI::saveProtocol()
{
	std::cout << HERE << std::endl;
...
bool BioZone6_GUI::saveProtocolAs()
{
	std::cout << HERE << std::endl;
...
void BioZone6_GUI::saveSettingsFile() {
...
void BioZone6_GUI::showToolsDialog() {
...
void BioZone6_GUI::showProtocolEditor() { 
...
void BioZone6_GUI::simulationOnly()
{
...
bool BioZone6_GUI::disCon(bool _connect)
{
	std::cout << HERE << std::endl;
...
void BioZone6_GUI::closeOpenDockTools() {
...
void BioZone6_GUI::resizeToolbar()
{
